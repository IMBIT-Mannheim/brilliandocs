...
:::caution
The IMBIT PIXELS repository is publicly accessible. Take special care not to include sensitive information.
:::

:::info
This documentation page is currently under developement and is subject to change.
:::
...
## Aseprite
Asperite is a tool for creating pixel art and animated sprites. It supports frame-by-frame animation and sprite editing.
A short YouTube video explains how to use Aseprite for free by compiling the open-source version: https://youtu.be/Ki-qvNx6CaU?feature=shared
