...
:::caution
The BrillianIDEAS repository is publicly accessible. Take special care not to include sensitive information.
:::
...
|-----------|---------------|----------------------------|------------|----------|--------------|------------|
| BrillianIDEAS | https://brillianideas.com | https://github.com/IMBIT-Mannheim/brillianideas.com | Apache 2.4.59, jQuery 3.3.1, jQuery Easy UI 1.5.1, jQuery Mobile 1.4.5 | N/A  | N/A         | Github Pages |


## Features
- **Server**: A combination of classic HTML enhanced with CSS and Javascript hosted on Github Pages.
...
As this is a simple html file, there is no application to start. Just browse the local html files with your browser or serve them with a VSCode extention like [Live Server](https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer).  
...
Can be found inside the old [Repositories Issues](https://github.com/IMBIT-Mannheim/brillianideas.com-AWS/issues) section.