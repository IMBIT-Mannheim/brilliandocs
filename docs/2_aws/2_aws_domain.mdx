...
Below is a quick reference table for all our domains, which are registered and managed by AWS Route 53.

### Domain List

| Applications     | Domain                        |
|-----------------|-------------------------------|
| BrillianIDEAS, BrillianDOCS, Wordpress Page, AWS SES  | [brillianideas.com](https://brillianideas.com)   |
...
| Unused | [digital-learning-imbit.com](https://digital-learning-imbit.com) |
